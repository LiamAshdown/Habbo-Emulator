...
namespace SteerStone
{
    ...
    void Opcodes::InitializePackets()
    {
        ...
        ///////////////////////////////////////////
        StoreClientPacket(PacketClientHeader::CLIENT_GDATE,                          "CLIENT_GDATE",                    PacketStatus::STATUS_ALL,                 PacketProcess::PROCESS_NOW,             &HabboSocket::HandleGDate                      );
        ...
        StoreClientPacket(PacketClientHeader::CLIENT_AC,                             "CLIENT_AC",                       PacketStatus::STATUS_AUTH,                PacketProcess::PROCESS_NOW,             &HabboSocket::HandleClientAC                   );
        ...
        StoreClientPacket(PacketClientHeader::CLIENT_COPPA_REG_GET_REAL_TIME,        "CLIENT_COPPA_REG_GET_REAL_TIME",  PacketStatus::STATUS_AUTH,                PacketProcess::PROCESS_NOW,             &HabboSocket::HandleCoppaRegGetRealTime        );
